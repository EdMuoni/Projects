...
from sys.partitions
where hobt_id = 123456789 --numbrite jada

-- muuta spTransaction1 
-- peab kasutama vea käsitlemisel try ja catchiga
-- update mitte muuta
-- kui transaction lõppeb, siis tuleb: select 'Transaction Successgul'
...
BEGIN
    ...
    BEGIN CATCH
        ...
        -- Kontrollime deadlocki veateadet
        IF ERROR_NUMBER() = 1205
            SELECT 'Transaction failed due to deadlock';
        ELSE
...
-- käivitada esimeses serveris e esimeses Queris aknas
exec spTransaction1

-- käivitada teises serveris e teises Queri aknas
exec spTransaction2
